    ...
    virtual bool Evaluate(double const *const *parameters, double *residuals, double **jacobians) const
    {
        ...
        if (jacobians)
        {
            ...
            if (jacobians[1])
            {
                ...
                if (fabs(jacobian_speedbias_i.maxCoeff()) > 1e8 || fabs(jacobian_speedbias_i.minCoeff()) > 1e8) {
                    return false;
                }
            }
            if (jacobians[2])
            {
                ...
                if (fabs(jacobian_pose_j.maxCoeff()) > 1e8 || fabs(jacobian_pose_j.minCoeff()) > 1e8) {
                    return false;
                }
            }
            if (jacobians[3])
            {
                ...
                if (fabs(jacobian_speedbias_j.maxCoeff()) > 1e8 || fabs(jacobian_speedbias_j.minCoeff()) > 1e8) {
                    return false;
                }
            }
        }
