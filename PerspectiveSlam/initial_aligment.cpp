...
MatrixXd TangentBasis(Eigen::Vector3d &g0)
{
    Eigen::Vector3d b, c;
...
void RefineGravity(map<double, ImageFrame> &all_image_frame, Eigen::Vector3d &g, VectorXd &x)
{
...
bool SolveScale(map<double, ImageFrame> &all_image_frame, Eigen::Vector3d &g, VectorXd &x)
{
    printf("SolveScale\n");
    int all_frame_count = all_image_frame.size();
...
bool VisualIMUAlignment(map<double, ImageFrame> &all_image_frame, Eigen::Vector3d* Bgs, Eigen::Vector3d &g, VectorXd &x)
{
